...
for i_episode in range(NUM_EPISODES):
    ...
    if i_episode % CHKP_FREQ == 0:
        ...
        plt.imsave(os.path.join(exp_dir, "render-{}-pred.png".format(i_episode)), npa(next_state))
        plt.imsave(os.path.join(exp_dir, "render-{}-gt.png".format(i_episode)), npa(state_raw))
